...
static const ShellCommand commands[] = {
		...
		{	"test", cmd_test},
#endif
		{ "reboot", cmd_reboot }, { "ledon", cmd_ledon },
		{ "ledoff", cmd_ledoff }, { NULL, NULL } };

static const ShellConfig shell_config = { (BaseSequentialStream *) &SD1,
		commands };
