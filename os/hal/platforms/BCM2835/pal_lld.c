...
void _pal_lld_init(const PALConfig* config) {
	...
	IOPORT0.gpeds = &GPEDS0;
	IOPORT0.gpren = &GPREN0;
	IOPORT0.gpfen = &GPFEN0;
	IOPORT0.gphen = &GPHEN0;
	IOPORT0.gplen = &GPLEN0;
	IOPORT0.gparen = &GPAREN0;
	IOPORT0.gpfen = &GPAFEN0;
	...
	IOPORT1.gpeds = &GPEDS1;
	IOPORT1.gpren = &GPREN1;
	IOPORT1.gpfen = &GPFEN1;
	IOPORT1.gphen = &GPHEN1;
	IOPORT1.gplen = &GPLEN1;
	IOPORT1.gparen = &GPAREN1;
	IOPORT1.gpfen = &GPAFEN1;
